...
// Allows to check real-time price 
// This file is going to be a Library.
// A library is similar to a smart contract which does not provide any state variables
// It can't send ether, and each function is internal
